...
1. There is a need to accurately disambiguate the Pāḷi consonants `b` and `v`. Thus BengPali facilitates the use of the letter `ৰ U+09F0` as the Pāḷi consonant `ba`, prevents the letter from rendering the glyph as a ligature of `r` due to its use in Assamese language.
